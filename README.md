...
If you have never used LuAshitacast before, and even if you have, read the following before continuing: [New User Guide](New-User.md)

# How to Use (cont.)

- Edit Equipment sets in [JOB].lua.
- Edit Elemental Staves (NQ vs HQ), Obis and other conditional mage gear and settings in ..\\common\\gcmage.lua if you are using these luas for mage jobs.
- Edit Fenrir's Earring, Dream Ribbon and other conditional melee gear and settings in ..\\common\\gcmelee.lua if you are using these luas for melee jobs.
...
- Make sure you fill out the fastcastValue etc. correctly in your [JOB].lua according to any Fast Cast gear contained in your Precast set.
