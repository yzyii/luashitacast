...
-- It takes approx. 2.00 to 2.50 seconds for a Ready to be executed.
-- 1.00 seconds is provided as a default conservative value which is typically sufficient worldwide but this value can be decreased if your internet is completely and consistently shit.
-- Do not increase this value beyond ~1.60 to allow for packet delay and the 0.25 sec loop delay on HandleDefault execution.
local petActionEquipmentDelay = 1.00
